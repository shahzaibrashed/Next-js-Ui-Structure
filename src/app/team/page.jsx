...
import SectionOne from '../Components/Team/SectionOne'
import SectionTwo from '../Components/Team/SectionTwo'
...
export default function Page() {
  ...
  return (
   ...
   <SectionTwo/>   
          ...
          <button
            onClick={handleClick}
            className="text-[#F0F0F0] bg-blue-500 p-2 fixed z-10 bottom-7 right-3 w-10 h-10 rounded-full flex items-center justify-center"
