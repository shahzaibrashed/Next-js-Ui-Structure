...
const SectionOne = () => {
  ...
  <div className="mt-[-50px] flex h-screen items-center justify-center">
    <div className="max-w-full flex-shrink-0 px-4 text-center lg:mx-0 lg:max-w-3xl lg:pt-8">
     ...
     Let’s 
        <span className="text-sky-500"> Connect </span> and 
        <span className="text-sky-500"> Collaborate </span>
      </h1>
      <p className="mt-6 text-lg leading-8 text-gray-300">
      Have questions, feedback, or need assistance? Our team is here to help. Reach out, and we’ll respond promptly.
      </p>
