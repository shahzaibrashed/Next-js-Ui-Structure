...
const TeamBanner = () => {
  ...
  <div className="mt-[-50px] flex h-screen items-center justify-center">
    <div className="max-w-full flex-shrink-0 px-4 text-center lg:mx-0 lg:max-w-3xl lg:pt-8">
      <h1 className="mt-10 md:text-5xl text-2xl font-bold tracking-tight text-white sm:text-6xl">
     Let’s 
        <span className="text-sky-500"> Meet </span> my 
        <span className="text-sky-500"> Teams </span>
      </h1>
      <p className="mt-6 text-lg leading-8 text-gray-300">
      Our team is the heart and soul of our success. Each member brings unique skills, passion, and a commitment to excellence that drives everything we do. Together, we innovate, collaborate, and strive to exceed expectations!
      </p>
